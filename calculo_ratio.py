...
if modo_calculo == "Cálculo RATIO CAM AM atención residencial":
    ...
    if st.session_state.get("cam_calculated"):
        ...
        st.markdown(
            ...
            f"Atención Directa (mínimo 0,47): {(rd/100):.2f} → {si_cumple_texto(cumple_directa)}"
            f"</p>",
        ...
        st.markdown(
            ...
            f"Atención No Directa (mínimo 0,15): {(rnd/100):.2f} → {si_cumple_texto(cumple_nodirecta)}"
            f"</p>",
            unsafe_allow_html=True
        )
        ...
        st.markdown(
            ...
            f"Gerocultores (mínimo 0,33): {ratio_gero:.2f} → {si_cumple_texto(cumple_gero)}"
            f"</p>",
            unsafe_allow_html=True
        )
        ...
        st.markdown(
            ...
            f"Horas introducidas: {h_fisio:.2f} → {si_cumple_texto(cumple_fisio)}"
            f"</p>",
            unsafe_allow_html=True
        )
        ...
        st.markdown(
            ...
            f"Horas introducidas: {h_to:.2f} → {si_cumple_texto(cumple_to)}"
            f"</p>",
            unsafe_allow_html=True
        )
        ...
        st.markdown(
            ...
            f"Trabajador Social: {horas_ts:.2f} h/sem → {si_cumple_texto(cumple_ts)} (mínimo > 0)"
            f"</p>",
            unsafe_allow_html=True
        )
        ...
        st.markdown(
            ...
            f"Médico: {horas_med:.2f} h/sem → {si_cumple_texto(cumple_med)} (mínimo 5h/sem)"
            f"</p>",
            unsafe_allow_html=True
        )
        ...
        st.markdown(
            ...
            f"Enfermería (ATS/DUE): {horas_enf:.2f} h/sem → {si_cumple_texto(cumple_enf)} (mínimo 168h/sem)"
            f"</p>",
            unsafe_allow_html=True
        )
