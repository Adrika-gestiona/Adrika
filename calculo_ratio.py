...
# ---------------------------------------------------------------------------------------------
# BLOQUE DE BRANDING (con sombreado, sin borde, www.mayores.ai en azul sin subrayado y - Ádrika en negro)
# ---------------------------------------------------------------------------------------------
branding_html = """
<div style="text-align: center; padding: 10px; background-color: #e6f0ff; margin-bottom: 10px;">
  <a href="https://www.mayores.ai" target="_blank" style="color: blue; text-decoration: none; font-weight: bold;">www.mayores.ai</a>
  <span style="color: black; font-weight: normal;"> - Ádrika</span>
</div>
"""
...
<head>
  ...
  <style>
    ...
    .branding {{ text-align: center; padding: 10px; background-color: #e6f0ff; margin-top: 10px; }}
  </style>
</head>
<body>
