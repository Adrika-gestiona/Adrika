...
st.title("www.mayores.ai - Ádrika")
st.header("Cálculo de ratio de personal")
    ...
    if st.session_state.get("orden2680_calculated"):
        ...
        if r2["deficit"] > 0:
            explanation = (
                ...
                f"<span style='font-weight:bold; background-color:yellow;'>Como mínimo el coste anual de personal se incrementaría en {formatear_numero(r2['coste_adicional'])} euros.</span><br>"
