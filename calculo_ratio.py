...
# ---------------------------------------------------------------------------------------------
# BLOQUE DE BRANDING (Cabecera y pie de página)
# ---------------------------------------------------------------------------------------------
branding_html = """
<div style="text-align: center; border: 2px solid blue; padding: 10px; background-color: #e6f0ff; margin-bottom: 10px;">
  <a href="https://www.mayores.ai" target="_blank" style="color: blue; text-decoration: underline; font-weight: bold;">
    www.mayores.ai - Ádrika
  </a>
</div>
"""
...
# Título principal de la app (CAM)
...
<head>
  ...
  <style>
    ...
    .branding {{ text-align: center; border: 2px solid blue; padding: 10px; background-color: #e6f0ff; margin-top: 10px; }}
  </style>
</head>
<body>
...
# ---------------------------------------------------------------------------------------------
# Al final de la aplicación, en la interfaz principal, se añade el branding con enlace
st.markdown(branding_html, unsafe_allow_html=True)