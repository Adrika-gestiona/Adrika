...
def calcular_equivalentes_jornada_completa(horas_semanales):
    ...
    return (horas_semanales * SEMANAS_ALO) / HORAS_ANUALES_JORNADA_COMPLETA  # Nota: se ha corregido a HORAS_ANUALES_JORNADA_COMPLETA
...
# INTERFAZ PRINCIPAL
# ---------------------------------------------------------------------------------------------
# Cabecera con títulos en dos líneas
st.markdown("<h4 style='text-align: center;'>www.mayores.ai - Ádrika</h4>", unsafe_allow_html=True)
...
# ---------------------------------------------------------------------------------------------
# Al final de la aplicación, en la interfaz principal, se añade el texto de marca
st.markdown("<p style='text-align: center;'>mayores.ai - Ádrika</p>", unsafe_allow_html=True)