...
if modo_calculo == "Cálculo RATIO CAM AM atención residencial":
    ...
    if st.session_state.get("cam_calculated"):
        ...
        """)
        st.markdown(f"""
        🔹 **Enfermería (ATS/DUE)**: Presencia 24h/día, 7 días/semana (≥168h/sem). Horas introducidas: **{horas_enf:.2f}** → {si_cumple_texto(cumple_enf)}
        ...
        # --------------------------------------------------------------------
        st.markdown("---")
        st.subheader("¿Desea generar el INFORME semanal en HTML con todos los datos?")
...
# ===============================================================
    ...
    if st.button("📌 Calcular Ratio (Orden 2680-2024)"):
        ...
        ratio_directa_2 = total_eq_directa_2 / ocupacion  # EJC por residente
