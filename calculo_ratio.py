...
# ---------------------------------------------------------------------------------------------
# BLOQUE DE BRANDING (con sombreado, sin borde)
# ---------------------------------------------------------------------------------------------
branding_html = """
<div style="text-align: center; padding: 10px; background-color: #e6f0ff; margin-bottom: 10px;">
  <a href="https://www.mayores.ai" target="_blank" style="color: blue; text-decoration: none; font-size: 20px;">www.mayores.ai</a>
  <span style="color: black; font-size: 20px;"> - Ádrika</span>
</div>
"""
...
if modo_calculo == "Cálculo RATIO CAM AM atención residencial":
    ...
    if st.session_state.get("cam_calculated"):
        ...
        # Opción para generar y descargar el informe HTML (CAM AM)
        st.markdown("---")
        ...
        if guardar_cam:
            ...
            # Generamos y mostramos el botón de descarga directamente
